...
public class Test {
	public static void main(String[] args){
		...
		try{
			...
			System.out.println(vc.addUser("Rafael", new Data(28, 1, 1994), 12345, 67405, "Engenharia de Computadores e Telemática"));
			
			vc.addVideo("Facebook Request", "Action", "ALL");
			vc.addVideo("Request", "Action", "M18");
			vc.addVideo("Eu", "Action", "M18");
			vc.addVideo("Eu Pa", "Action", "M18");
					...
					switch(opcao){
						...
						case 9:
							...
							if(vc.filmeDisponivel(id_video)){
								...
								System.out.println("O filme não está dispon√≠vel!");
							}
							break;
						case 10:
